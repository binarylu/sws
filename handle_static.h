...
int set_file(const _request *request, const char *path, const struct stat *req_stat, _response *response);
int set_directory(const _request *request, const char *path, struct stat *req_stat, _response *response);
